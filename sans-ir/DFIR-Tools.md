...
- [Windows Artifact & Registry Forensics](#windows-artifact--registry-forensics)
- [Linux & macOS Forensics](#linux--macos-forensics)
- [Network Forensics](#network-forensics)
- [Incident Response & Live Response](#incident-response--live-response)
- [Malware Analysis (DFIR Support)](#malware-analysis-dfir-support)
- [DFIR Linux Distributions](#dfir-linux-distributions)
- [Commercial DFIR Tools (Free Editions)](#commercial-dfir-tools-free-editions)
- [Official Tool Links – Quick Reference](#official-tool-links--quick-reference)
...
- **Guymager** – https://guymager.sourceforge.net  
...
## Windows Artifact & Registry Forensics
...
## Incident Response & Live Response
...
- **FastIR Collector** – https://github.com/certsocietegenerale/Fastir_Collector  
- **CyLR** – https://github.com/orlikoski/CyLR  
- **PowerForensics** – https://github.com/Invoke-IR/PowerForensics  

---

## Malware Analysis (DFIR Support)
...
## 🏢 Commercial DFIR Tools (Free Editions)

> Commercially developed tools that are **officially free** and commonly used in DFIR.

- **FTK Imager** – https://www.exterro.com/ftk-imager  
- **BelkaImager** – https://belkasoft.com/belkaimager  
...
## 🔗 Official Tool Links – Quick Reference
...
- https://guymager.sourceforge.net
...
- https://www.magnetforensics.com/resources/magnet-dumpit
...
- https://github.com/certsocietegenerale/Fastir_Collector
